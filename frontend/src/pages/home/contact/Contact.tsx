...
const Contact = () => {
  ...
  return (
    <motion.div
      ref={ref}
      className={`${styles.contact} w-4/5 h-screen `}
    ...
    >
      <motion.div
        ...
        whileInView='animate'
      >
        <motion.h1 className='text-[#00749E] dark:text-[#50A7D3]'>
          Let's work
          <br /> together{' '}
        </motion.h1>
        <motion.div className='item' variants={variants}>
          <h2>Mail</h2>
          <span>bekttur@mail.ru</span>
        </motion.div>
        <motion.div className='item' variants={variants}>
          <h2>Address</h2>
          <span>Astana, street A.Bokeykhanov 15/1</span>
        </motion.div>
        <motion.div className='item' variants={variants}>
          <h2>Phone</h2>
          <span>+7 (708) 540 42-08</span>
        </motion.div>
      </motion.div>
      <motion.div
      ...
      >
        ...
        >
          <svg height='300px' width='300px' viewBox='0 0 512 512'>
            <g>
              <g>
                <motion.path
                  strokeWidth={3}
        ...
        >
          ...
          {loading === true ? (
            ...
            <ButtonUI title='Submit' type='submit' />
          )}
        </motion.form>
      </motion.div>
    </motion.div>
